...
package com.iclub.dineart.record;
...
import com.iclub.dineart.NdefMessageParser;
import com.iclub.dineart.R;
...
public class SmartPoster implements ParsedNdefRecord {
    ...
    @Override
    public String getStr(Activity a, LayoutInflater li, ViewGroup vg, int off) {
        return "fuck";
    }
